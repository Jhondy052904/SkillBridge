...
DATABASES = {
    "default": dj_database_url.config(
        default="postgresql://postgres:Skillbridge9@db.sfgnccdbgmewovbogibo.supabase.co:6543/postgres",
        conn_max_age=0,       # close idle connections immediately to avoid pool limits
        ssl_require=True      # Supabase requires SSL for pooled connections
    )
}
